codeunit 50115 SelectionFilterMgmt
{
    ...
    //H2o >>
    procedure GetSelectionFilterForResCategory(var ResCategory: Record "Resource Category"): Text
    var
        RecRef: RecordRef;
    begin
        RecRef.GetTable(ResCategory);
        exit(GetSelectionFilter(RecRef, ResCategory.FieldNo(Code)));
    end;
    //H2O <<
