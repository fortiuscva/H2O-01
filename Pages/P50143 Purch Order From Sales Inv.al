page 50143 "Purch. Order From Sales Inv"
{
        ...
        area(content)
        {
            repeater(Group)
            {
                ...
                field(Vendor; VendorName)
                {
                    ...
                    begin
                        rec.TestField("Replenishment System", "Replenishment System"::Purchase);
                        if not rec.LookupVendor(Vendor, false) then
                            exit;

                        rec.SetCurrFieldNo(rec.FieldNo("Supply From"));
                        rec.Validate("Supply From", Vendor."No.");
                    ...
                    begin
                        ...
                        rec.SetCurrFieldNo(rec.FieldNo("Supply From"));
                        rec.Validate("Supply From", Vendor.GetVendorNo(VendorName));
    ...
    procedure SetSalesInvoiceNo(SalesInvoiceNo: Code[20])
    begin
